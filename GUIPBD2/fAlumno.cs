                ...
                if (this.Valida())
                {
                    switch (this.Modo)
                    {
                        ...
                        case "actualizar":
                            ...
                            int id = int.Parse(this.iDAlumnoTextBox.Text);
                            this.alumnoTableAdapter.Update(this.nombreTextBox.Text, this.primerApellidoTextBox.Text, this.segundoApellidoTextBox.Text, this.nombreTextBox.Text, this.emailTextBox.Text, telefonoTextBox.Text, id);
                            break;
                    }
                    this.CargaDatos();
                }
