            ...
            try
            {
                    switch (this.Modo)
                    {
                        case "insertar":
                            ...
                            this.alumnoEmpresaTableAdapter.Insert((int)this.cboAlumno.SelectedValue, (int)this.cboAlumno.SelectedValue,(short)this.anioInicioNumericUpDown.Value, (short)this.anioFinNumericUpDown.Value);
                            break;
                        case "actualizar":
